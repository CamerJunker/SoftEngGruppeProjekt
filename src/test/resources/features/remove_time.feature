Feature: Remove time
    ...
    Scenario: Employee removes time from an activity
        Given an employee with initials "huba" has registered time to remove
        And an activity "Programming" exists in project with serial number "26011" for removing time
    ...
    Scenario: Employee tries to remove more time than registered
        ...
        Then the system returns the remove time error "Cannot remove more hours than registered"
