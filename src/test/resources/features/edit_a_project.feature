...
# 	Given the employee is logged in
# 	And the employee is the project manager of a project with the name "Project1"
...
# 	And the employee is not the project manager of a project with the name "Project1"
# 	When the employee edits the project name to "Project2"
# 	Then the error message "Employee is not the project manager" is given
